...
const Features = () => {
  ...
  return (
    <div id="featues">
      ...
      <Title title='Build your resume' description='Our streamlined process helps you create a professional resume in minutes with intelligent AI-powered and features.'/>
