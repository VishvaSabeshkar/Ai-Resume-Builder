...
const CallToAction = () => {
  return (
    <div id='cta' className="max-w-5xl mx-2 md:mx-auto p-px rounded-2xl bg-gradient-to-r from-green-600/20 to-green-500/30 mt-10, mb-10" >
            <div className="flex flex-col items-center justify-center text-center py-12 md:py-16 rounded-[15px] bg-gradient-to-r from-[#ffffff] to-[#d4fbd8]">  
                <div className="flex items-center justify-center bg-white px-3 py-1.5 shadow gap-1 rounded-full text-xs">
                    ...
                    <span className="bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent font-medium">Trusted by Experts</span>
                </div>
                <h10 className="text-2xl md:text-4xl font-medium mt-2">
                    Build a  
                    <span className="bg-gradient-to-r from-green-600 to-green-500 bg-clip-text text-transparent"> Professional Resume </span> <br/>
                    That Helps You Stand Out and Get Hired.
                </h10>
                <button type="button" className="bg-gradient-to-r from-green-600 to-green-500 text-white text-sm px-5 py-2.5 rounded-xl font-medium mt-4 hover:scale-105 active:scale-95 transition-all duration-300"> 
                    Get Started Today
                </button>
            </div>
        </div>
