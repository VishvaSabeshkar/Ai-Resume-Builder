...
const Testimonial = () => {
    ...
    const CreateCard = ({ card }) => (
        <div className="p-4 rounded-lg mx-4 shadow hover:shadow-lg transition-all duration-200 w-72 shrink-0">
            ...
            <p className="text-sm py-4 text-gray-800">Super easy to use and the templates are clean and professional. I had my resume ready in under 10 minutes. Highly recommend for anyone job hunting!</p>
        </div>
    );
  ...
  return (
    ...
    <div id="testimonials" className='flex flex-col items-center my-10 scroll-mt-12'>
        <div className="flex items-center gap-2 text-sm text-green-800 bg-green-400/10 rounded-full px-6 py-1.5 transition-all duration-200 hover:bg-green-500/20 hover:text-green-900 cursor-pointer" >
